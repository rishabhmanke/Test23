...
setwd( "/Users/rmanke/Documents/Rishabh Documents/R Programing/GL");
...
#Interprit the coefficients
#As the CR.Score goes up what happens to predicted probability
...
##### Final Model Retain only significant ones
...
val.logit$pred1 <- pred.logit.final 
View(val.logit);
#Classification
...
tab.logit
accuracy<-(194+37)/(199+40)
accuracy;
relevant.accuracy<-(194)/(194+3);
relevant.accuracy;
